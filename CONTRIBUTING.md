# Contributing to blackroad-earth
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-earth.git
cd blackroad-earth

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-earth.git
